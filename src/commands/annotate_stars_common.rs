...
pub fn create_annotated_image(
    ...
    eprintln!("Annotating {} stars out of {} detected", stars_to_annotate.len(), detection_result.stars.len());
    ...
    for (x, y, hfr) in &stars_to_annotate {
        ...
        // Draw hollow circle
        draw_hollow_circle_mut(&mut rgb_image, (*x as i32, *y as i32), radius, annotation_color);
